...
const App = function() {
  return (
    <div className="metu-ui" style={{ width: '70%', margin: 'auto' }}>
      ...
      <Button btnType="danger" ghost>Danger</Button>

      <p></p>

      <Button btnType="primary" ghost disabled>Primary ghost disabled</Button>
      <Button btnType="danger" ghost disabled>Danger ghost disabled</Button>
